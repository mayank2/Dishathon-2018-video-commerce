...
var JSSDKDemo = (function() {
    ...
    var run = function() {
        ...
        var myVideo = document.getElementById("wo"); 
        var myVideoad = document.getElementById("woadd"); 
        //myVideo.play();
...
var video = document.getElementById('woadd2');
var source = document.createElement('source');

$(document).ready(function(){
   $('#wo').one('play', function () {
       //code here
       console.log("Video of transformers is selected")
        //begin_capture()
        myVideo = document.getElementById("wo"); 
        setTimeout(function () {
         myVideo.pause();
         begin_capture();
         ...
         if(finalage>17){
            ...
            myVideoad2 = document.getElementById("woadd2");
            source.setAttribute('src', 'beats_adadult.mp4');
         }
         else{
            console.log("you are under 18.");
            myVideoad2 = document.getElementById("woadd2");
            source.setAttribute('src', 'beats_adchild.mp4');
...
$(document).ready(function(){
   $('#wo2').one('play', function () {
       //code here
       console.log("Video of phir hera pheri is selected")
        //begin_capture()

        myVideo = document.getElementById("wo2"); 
        source.setAttribute('src', 'dominoesad.mp4');
        video.appendChild(source);
        setTimeout(function () {
         myVideo.pause();
         begin_capture();
...
$(document).ready(function(){
   $('#wo3').one('play', function () {
       //code here
       console.log("Video of koi mil gya is selected")
        //begin_capture()
        myVideo = document.getElementById("wo3"); 
        source.setAttribute('src', 'bournvitaad.mp4');
        video.appendChild(source);
        setTimeout(function () {
         myVideo.pause();
         begin_capture();
        ...
        detector.addEventListener("onImageResultsSuccess", function(faces, image, timestamp) {
            ...
            if (capture_frames) {
                ...
                if (faces.length > 0) {
                    ...
                    userage = faces[0].appearance["age"];
                    finalage = userage.slice(0, 2);
                    ...
                    console.log('results', 'Emotion: ' + maxEmotion);
                    let check = 1
                    good = 0
                    bad = 0
                    switch(maxEmotion) {
                    ...
                    console.log('maximum result is ', 'Emotion: ' + maxEmotion );
                    if(check===0){
                        // stop_capture();
...
$(document).ready(function(){
                    ...
                    $("#woadd2").one("ended", function() {
                    //play the main video
                    stop_capture();
                    if(good>bad){
                        window.alert("The ads was positive. Show more like this.");
                    }
                    else{
                        window.alert("The ads was negative. Don't show more like this.");
                    }
    ...
    var video_ids = ["t4YwLlB9daM", "H_4g5rnDOVk", "H_4g5rnDOVk", "dlNO2trC-mk", "lhzwmYRXPp4", "0kfLd52jF3Y"];
